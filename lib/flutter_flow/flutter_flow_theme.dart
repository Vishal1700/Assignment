...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFF037E);
  late Color secondary = const Color(0xFFFFE360);
  ...
  late Color accent1 = const Color(0xFFFF7FBD);
  late Color accent2 = const Color(0xFFFFE77C);
